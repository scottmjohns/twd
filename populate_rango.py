...
def populate():
	...
	add_page(cat=django_cat, title="Official Django Tutorial", url="https://docs.djangoproject.com/en/1.5/intro/tutorial01/", views=30)
	add_page(cat=django_cat, title="Django Rocks",             url="http://www.djangorocks.com/", views=400)
	add_page(cat=django_cat, title="How to Tango with Django", url="http://www.tangowithdjango.com/", views=10)
